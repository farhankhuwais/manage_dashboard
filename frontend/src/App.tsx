...
const INFO_SELECT_FIELDS: { key: keyof Member; label: string; options: string[] }[] = [
  ...
  { key: "pekerjaan", label: "Pekerjaan", options: ["Pensiunan", "Karyawan Swasta", "Ibu Rumah Tangga", "Wiraswasta", "Organisasi Nirlaba", "Tenaga Medis", "Freelancer", "Influencer", "ASN", "Pelajar", "Pelaut", "Pendeta", "Belum Bekerja", "Mahasiswa"] },
...
const FORM_SECTIONS: { title: string; fields: FormField[] }[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { type: "select", key: "pekerjaan", label: "Pekerjaan", options: ["Pensiunan", "Karyawan Swasta", "Ibu Rumah Tangga", "Wiraswasta", "Organisasi Nirlaba", "Tenaga Medis", "Freelancer", "Influencer", "ASN", "Pelajar", "Pelaut", "Pendeta", "Belum Bekerja", "Mahasiswa"] },
